...
namespace TIX_API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<OutputUser>>> GetUsers()
        {
            ...
            string StoredProc = "exec dbo.GetUsers";
            return await _context.OutputUsers.FromSqlRaw(StoredProc).ToListAsync();
        }

        // GET: api/Users/5
        [HttpGet("{id}")]
        public async Task<ActionResult<OutputUser>> GetAllUsers(int id)
        {
            //if (_context.Users == null)
            //{
            //    return NotFound();
            ...
            string StoredProc = "exec dbo.GetUsers @id=" + id;
            var user = await _context.OutputUsers.FromSqlRaw(StoredProc).ToListAsync<OutputUser>();
            OutputUser UserInfo = new OutputUser()
            {
